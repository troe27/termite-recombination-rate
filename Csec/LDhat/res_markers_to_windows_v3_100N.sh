...
resfile="concat_Csec_geq1000_rmind_hardfilt_exhet_biall_dp_qfilt_mac2_maxmiss06_rmfilt_sedmiss_phimp_LDhat_bpen1_statres_filtMQ70depth2stdev.txt"
...
cat $resfile | tail -n +2 | awk -v wsize=$wsize ' BEGIN {rhosum=0; lensum=0; X=1; k=1000; wsizekb=wsize/k; scaff="NEVH01000001.1"; w_start=0; w_end=wsize} \
