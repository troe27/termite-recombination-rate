...
setwd("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/rho_peaks_analysis/Mbel_100N/filt_MQ_val_70_depth_2stdev_from_mean/GC_CpG_SNPdens_corr")

# rho_data_w100kb <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/rho_peaks_analysis/Mbel_100N/filt_MQ_val_70_depth_2stdev_from_mean/concat_Mbel_excl5scaff_rmind_hardfilt_exhet_biall_dp_qfilt_mac2_maxmiss06_phimp_LDhat_bpen1_statres_100N_filtMQ70depth2stdev.txt_w100kb",header=TRUE)
# # Scaffold	Start_bp	End_bp	Rho_kb	seq_len_with_data_bp
# rho_data_w10kb <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/rho_peaks_analysis/Mbel_100N/filt_MQ_val_70_depth_2stdev_from_mean/concat_Mbel_excl5scaff_rmind_hardfilt_exhet_biall_dp_qfilt_mac2_maxmiss06_phimp_LDhat_bpen1_statres_100N_filtMQ70depth2stdev.txt_w10kb",header=TRUE)
# rho_data_w1kb <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/rho_peaks_analysis/Mbel_100N/filt_MQ_val_70_depth_2stdev_from_mean/concat_Mbel_excl5scaff_rmind_hardfilt_exhet_biall_dp_qfilt_mac2_maxmiss06_phimp_LDhat_bpen1_statres_100N_filtMQ70depth2stdev.txt_w1kb",header=TRUE)
# 
# scaff_list <- unique(rho_data_w10kb$Scaffold)
# #Not all scaffolds are included in output from LDhat (rho_data) - some probably too short to do any recomb calc on
# 
# #********** Scaff len analysis
# scaff_lengths_temp <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/Mbel_scaffolds_lengths_final_set_sorted.txt",header=FALSE)
...
# }
# 
# plot(scaff_lengths$Len,scaff_lengths$Rho_kb,type="p",pch=20)
# hist(scaff_lengths$Len,col="slateblue",breaks=30)
# #********************* 
#
# w100kb <- 100000
# w10kb <- 10000
...
# cpg_data_w100kb_temp <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/CpG/Mbel_per_base_content_wind_100000b_repeatmask_xcount.txt",header=TRUE)
# # contig	a_frac	t_frac	g_frac	c_frac	x_count	lower_frac	upper_frac	tot_count	cpg_count	cpg_exp	cpg_obs_exp
# cpg_data_w10kb_temp <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/CpG/Mbel_per_base_content_wind_10000b_repeatmask_xcount.txt",header=TRUE)
# cpg_data_w1kb_temp <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/CpG/Mbel_per_base_content_wind_1000b_repeatmask_xcount.txt",header=TRUE)
# 
# scaff_lengths_temp <- read.table("/home/turid/Documents/HoneyBees/termites/resuming_project_2023/rho_per_wind/concat/Mbel_scaffolds_lengths_final_set_sorted.txt",header=FALSE)
# colnames(scaff_lengths_temp) <- c("Scaffold","Len")
# 
...
# }
# 
# write.table(cpg_data_w100kb,"Mbel_per_base_content_w100kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")
# write.table(cpg_data_w10kb,"Mbel_per_base_content_w10kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")
# write.table(cpg_data_w1kb,"Mbel_per_base_content_w1kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")

#***********************************************
# Produce files with rho, CpG, GC and pi for each window, skip this if files already produced

# pi_data_w100kb_temp <- read.table("Mbel_concat_excl5scaff_rmind_hfilt_exhet.vcf_biall_dp_qfilt_mac2_maxmiss06_rmfilt_sedmiss_phimp_MQ70_dp2stdev_v4_w100kb.pi",header=TRUE)
# #CHROM	BIN_START	BIN_END	N_VARIANTS	PI
# pi_data_w10kb_temp <- read.table("Mbel_concat_excl5scaff_rmind_hfilt_exhet.vcf_biall_dp_qfilt_mac2_maxmiss06_rmfilt_sedmiss_phimp_MQ70_dp2stdev_v4_w10kb.pi",header=TRUE)
# pi_data_w1kb_temp <- read.table("Mbel_concat_excl5scaff_rmind_hfilt_exhet.vcf_biall_dp_qfilt_mac2_maxmiss06_rmfilt_sedmiss_phimp_MQ70_dp2stdev_v4_w1kb.pi",header=TRUE)
# 
...
# 
# cpg_data_w100kb <- read.table("Mbel_per_base_content_w100kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",header=TRUE)
...
# cpg_data_w10kb <- read.table("Mbel_per_base_content_w10kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",header=TRUE)
# cpg_data_w1kb <- read.table("Mbel_per_base_content_w1kb_repeatmask_xcount_final_scaffold_set_pos_start_end.txt",header=TRUE)
# 
...
# write.table(rho_data_w100kb,"Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w100kb.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")
# write.table(rho_data_w10kb,"Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w10kb.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")
#write.table(rho_data_w1kb,"Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w1kb.txt",row.names=FALSE,col.names=TRUE,quote=FALSE,sep="\t")

#********* Start here if files above already produced

rho_data_w100kb <- read.table("Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w100kb.txt",header=TRUE)
rho_data_w10kb <- read.table("Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w10kb.txt",header=TRUE)
# rho_data_w1kb <- read.table("Mbel_rho_CpG_GC_pi_finalfilt_MQ70_dp2stdev_w10kb.txt",header=TRUE) #have not produced this file...
...
par(mfrow=c(1,3))
# plot_title <- paste("Mbel, windows >= half wind length = ",round(100*rho_data_w100kb_plot_len/rho_data_w100kb_tot_len,digits=2)," % of tot seq length")
...
plot_title <- paste("Mbel, w10kb, windows >= half wind length = ",round(100*rho_data_w10kb_plot_len/rho_data_w10kb_tot_len,digits=2)," % of tot seq length")
...
# plot_title <- paste("Mbel, windows >= half wind length = ",round(100*rho_data_w1kb_plot_len/rho_data_w1kb_tot_len,digits=2)," % of tot seq length")
